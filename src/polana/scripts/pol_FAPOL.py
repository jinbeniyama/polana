...
# -*- coding: utf-8 -*-
"""
Do photometry for images obtained with NOT/FAPOL.
Pixel scale is 0.214 arcsec/pix.  (To Be Confirmed)
https://www.not.iac.es/instruments/instruments.html

Both ordainary and Extra-ordinary sources exist in a single fits.
right is ordinary, left is extra-ordinary (priv. com. w/ Julia on 2026 June in La Palma)
...
from polana.util import utc2alphaphi, remove_bg_2d, loc_NOT, obtain_winpos
...
def main(args=None):
    ...
    for x in args.inp:
        ...
        for idx_set in range(N_set):
            ...
            insrot1   = (float(insrot000) + float(insrot450))*0.5
            ...
            insrot2   = (float(insrot225) + float(insrot675))*0.5
            ...
            if args.mp:
                ut = df_res.at[0, "utc"]
                alpha, phi = utc2alphaphi(args.obj, ut, loc_NOT)
